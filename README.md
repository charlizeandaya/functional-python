# Functional Python [![](https://github.com/charlizeandaya/functional-python/workflows/tests/badge.svg)](https://github.com/charlizeandaya/functional-python/actions?query=workflow%3Atests)
